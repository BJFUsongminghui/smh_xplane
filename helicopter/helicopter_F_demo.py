...
def display_frames_as_gif(frames):
    ...
    anim = animation.FuncAnimation(plt.gcf(), animate, frames=len(frames), blit=False, interval=300, save_count=300)
    anim.save('./helicopter.gif', writer='ffmpeg', fps=30, dpi=300)
        ...
        while(True):
           ...
           # print(s_)
            ...
            if ddpg.pointer > MEMORY_CAPACITY_TRAIN:
                loss_a, loss_c = ddpg.learn()   # edited by wsr 2021-5-31，记录loss
            ...
            if done :
                ...
                writer.add_scalar('memory size', len(ddpg.table), global_step=i)
