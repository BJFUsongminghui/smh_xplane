...
class DDPG:
    ...
    def update(self,batch_size):
      ...
      data = {k: torch.as_tensor(np.array(v), dtype=torch.float32,device=device) for k,v in data.items()}
